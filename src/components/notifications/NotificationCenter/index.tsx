...
} from "../../../hooks/useProgressNotifications";
  ...
  const getNotificationIcon = (type: ProgressNotification["type"]) => {
    switch (type) {
      case "completion":
        return (
          <svg
            className={`${styles.icon} ${styles.completion}`}
            viewBox="0 0 24 24"
          >
      ...
      case "milestone":
        return (
          <svg
            className={`${styles.icon} ${styles.milestone}`}
            viewBox="0 0 24 24"
          >
    ...
    >
      ...
      <div className={styles.content}>
        ...
        <p className={styles.message}>
          Updated "{notification.taskTitle}" to {notification.progress}%
          complete
        </p>
