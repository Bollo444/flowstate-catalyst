...
const whisperCategories: WhisperCategory[] = [
  {
    ...
    messages: [
      ...
      { text: "Maintaining that Flowtastic momentum! 🚀", intensity: "energetic" }
    ],
  ...
  },
  {
    ...
    messages: [
      { text: "30 minutes of pure flow! Flowtastic! ✨", intensity: "energetic" },
      { text: "You've maintained Flowtastic movement for 1 hour! 🎯", intensity: "energetic" }
    ],
    triggers: [], // Add triggers if needed
    intensity: "energetic"
  },
  {
    ...
    name: 'Flow Check-ins',
    messages: [
      { text: "Still in the Flowtastic zone? Tap an emoji! 🎭", intensity: "gentle" },
